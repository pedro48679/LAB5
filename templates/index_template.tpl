        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav mb-auto mb-2 mb-lg-0" >
            <ul class="navbar-nav mb-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item"><a class="nav-link" href="./templates/login_template.php">Login</a></li>
              <li class="nav-item"><a class="nav-link" href="register.php">Register</a></li>
              <li class="nav-item"><a class="nav-link" href="./templates/login_template.php">Post blog</a></li>
            </ul>
          </ul>
        </div>
      </div>
